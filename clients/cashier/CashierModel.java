...
//  }
//  public void doRemove() {                                                //CHANGED
//    String theAction = "";
//    int    amount  = 1;                       //  & quantity
//    try
//    {
//      if ( !(theBasket != null &&
//              theBasket.size() >= 1) )          // basket empty
//      {
//        theAction = "The basket is empty";
//      } else {
//          makeBasketIfReq();                    //  new Basket ?
//          theBasket.remove( theProduct );       //  remove from basket
//          theStock.addStock(                    //  add back to stock
//                  theProduct.getProductNum(),   //  product details
//                  theProduct.getQuantity());
//          theAction = "Removed " +              //  update action
//                  theProduct.getDescription();
//      }
//    } catch( StockException e )                 //  may fail
//    {
//      DEBUG.error( "%s\n%s",
